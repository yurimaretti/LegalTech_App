...
@Composable
fun CadClienteScreen(navController: NavController) {
    Box(
        ...
        Column(
            ...
            val usuario = UsuarioModel(cpf, nome, email, telefone, cidade, estado)
                        ...
                        Row(
                            ...
                            Botao(
                                onClick = {
                                    ...
                                    val call = apiService.incluirUsuario(usuario)
...
@Composable
fun CadClienteScreenPreview() {
    CadClienteScreen(rememberNavController())
}